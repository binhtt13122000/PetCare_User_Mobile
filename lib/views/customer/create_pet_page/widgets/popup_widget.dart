...
class CreatePetPopupWidget extends GetView<CreatePetPageController> {
  const CreatePetPopupWidget({Key? key}) : super(key: key);
          ...
          child: Container(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Create pet ${controller.petName.value} successfully!',
