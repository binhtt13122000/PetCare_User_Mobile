...
class SaleTransactionForBuyerDetailPage
    extends GetView<TransactionPageController> {
  const SaleTransactionForBuyerDetailPage({Key? key, required this.index})
      : super(key: key);
  final int index;
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  FORMAT_MONEY(
                                      price: controller
                                          .saleTransactions[index].deposit),
                                  style: GoogleFonts.quicksand(
                                    fontSize: 15,
                                    fontWeight: FontWeight.w500,
                                    color: PRIMARY_COLOR,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        FORMAT_MONEY(
                            price:
                                controller.saleTransactions[index].totalPrice),
                        style: GoogleFonts.quicksand(
                          fontSize: 15,
                          fontWeight: FontWeight.w500,
                          color: DARK_GREY_COLOR.withAlpha(200),
                    ...
                    children: [
                      Text(
                        ...
                        style: GoogleFonts.quicksand(
                          fontSize: 15,
                          fontWeight: FontWeight.w500,
                          color: const Color.fromARGB(197, 40, 201, 201),
                        ),
                      ),
                      Text(
                        '- ' + FORMAT_MONEY(price: 0),
