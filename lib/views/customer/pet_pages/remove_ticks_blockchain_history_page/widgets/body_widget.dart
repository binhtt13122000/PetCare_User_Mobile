...
class RemoveTicksBlockchainHistoryBodyWidget
    extends GetView<PetBlockChainPageController> {
  const RemoveTicksBlockchainHistoryBodyWidget({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Column(
            children: controller.petHealthRecordMap['TICKS']!
                .asMap()
                .entries
