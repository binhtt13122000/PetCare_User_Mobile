...
class BuyServicesComboWebViewWidget
    extends GetView<BuyServicesComboPageController> {
  const BuyServicesComboWebViewWidget({Key? key}) : super(key: key);
                      ...
                      child: InAppWebView(
                        ...
                        onLoadStart: (InAppWebViewController controller,
                          ...
                          BuyServicesComboPageController
                              buyServicesComboPageController =
                              Get.find<BuyServicesComboPageController>();
                          if (uri!.path == PET_COMBO_RETURN_API_PATH) {
                            buyServicesComboPageController
                              ..paymentUrl.value = ''
