...
import 'package:petapp_mobile/views/customer/transaction_pages/order_detail_page/widgets/popup_widget.dart';
import 'package:petapp_mobile/views/customer/transaction_pages/order_detail_page/widgets/review_popup_widget.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          const OrderDetailReviewPopupWidget(),
          const OrderDetailPopupWidget(),
          Obx(
