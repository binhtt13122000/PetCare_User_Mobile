...
class PetComboDetailTopWidget extends GetView<PetComboDetailPageController> {
  const PetComboDetailTopWidget({Key? key}) : super(key: key);
          ...
          children: [
            ...
            Expanded(
              child: FittedBox(
                ...
                child: CUSTOM_TEXT(
                  'Pet Services Combo Details Page',
