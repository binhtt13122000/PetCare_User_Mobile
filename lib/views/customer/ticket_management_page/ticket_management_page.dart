...
import 'package:petapp_mobile/graphql/query_mutation/ticket.dart';
...
class TicketManagementPage extends GetView<TicketManagementPageController> {
            ...
            children: [
                  ...
                  child: Material(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Search a ticket by title...',
              ...
              SingleChildScrollView(
                child: Row(
                  ...
                  children: controller.ticketTypeList
                      .asMap()
                      .entries
                      .map((e) => ticketTypeItemWidget(ticketType: e.value))
                      .toList(),
                ),
              ),
              //!Table header
                    ...
                    child: InkWell(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Obx(
                            () => SvgPicture.asset(
                              controller.petManagementTableHeaders['Title'] == 2
                                  ? ICON_PATH + TOPWARD_ARROW_SVG
                                  : ICON_PATH + DOWNWARD_ARROW_SVG,
                              color: controller
                                          .petManagementTableHeaders['Title'] ==
                                      0
                                  ? LIGHT_GREY_COLOR
                    ...
                    child: InkWell(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Obx(
                            () => SvgPicture.asset(
                              controller.petManagementTableHeaders['Status'] ==
                                      2
                                  ? ICON_PATH + TOPWARD_ARROW_SVG
                                  : ICON_PATH + DOWNWARD_ARROW_SVG,
                              color: controller.petManagementTableHeaders[
                                          'Status'] ==
                                      0
                                  ? LIGHT_GREY_COLOR
                                  : const Color.fromARGB(255, 244, 55, 165),
              ...
              Padding(
                ...
                child: MaterialButton(
                  ...
                  color: PRIMARY_LIGHT_COLOR,
                  child: InkWell(
                    onTap: () => Get.toNamed(CREATE_TICKET_PAGE_ROUNTER),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(
  ...
  Widget ticketItemWidget(
          {required TicketModel ticketModel, bool isLastIndex = false}) =>
      Column(
  ...
  Widget ticketTypeItemWidget({required String ticketType}) => Obx(
        () => InkWell(
          onTap: () {
            controller.selectedTicketType.value == ticketType
                ? null
                : controller.selectedTicketType.value = ticketType;
          },
          child: Container(
            ...
            decoration: BoxDecoration(
              color: controller.selectedTicketType.value == ticketType
                  ? PRIMARY_COLOR
                  : WHITE_COLOR,
